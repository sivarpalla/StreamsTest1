...
public class Exercise5 {
	...
	public static void main(String[] args) {
		...
		Function<ContinentCityPair, City> extractCity = ContinentCityPair::getCity;
		var highPopulatedCapitalCityOfEachContinent = 
				countryDao.findAllCountries()
				          ...
				          .filter(pair -> Objects.nonNull(pair.getCity()))
				          .collect(Collectors.groupingBy(ContinentCityPair::getContinent,Collectors.maxBy(Comparator.comparing(extractCity.andThen(City::getPopulation)))));
